...
from waggy_labs.blocks import CodeBlock, DEFAULT_CODEBLOCK_LANGS
...
class CodeBlockAdapter(StructBlockAdapter):
    ...
    """
    js_constructor = 'waggy_labs.blocks.CodeBlock'
    ...
    def media(self):
        ...
        return forms.Media(
            js = structblock_media._js + [
                'waggy_labs/js/code_block/code-block.js',
                codemirror_js,
                ] + codemirror_modes,
            css = {
                "all": (
                    f'https://cdnjs.cloudflare.com/ajax/libs/codemirror/{codemirror_ver}/codemirror.min.css',
                    'waggy_labs/css/code_block/codemirror.tweaks.css',
                )
            }
        )
