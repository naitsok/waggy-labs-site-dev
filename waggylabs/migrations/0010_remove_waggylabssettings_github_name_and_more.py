...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('waggylabs', '0009_waggylabssettings_show_social_names'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='social_links', to='waggylabs.waggylabssettings')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
